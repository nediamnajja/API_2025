...
from db import course_items  # Fixed: was 'items' but should be 'course_items'
...
class Course_Item(MethodView):
    ...
    def put(self, course_item_id):
        ...
        try:
            ...
            course_item |= course_item_data  # This merges the dictionaries
...
class CourseItemList(MethodView):  # Fixed: Changed from 'ItemList' to 'CourseItemList'
    def get(self):
    ...
    def post(self):
        ...
        # Fixed: Changed from 'item' to 'course_item' in the loop
